...
function App() {
  ...
  const servicos = [
    {
      ...
      descricao: "Alívio imediato e tratamento indolor para onicocriptose. Remoção da espícula e curativo especializado.",
      icone: <Scissors size={24} className="text-brand-500" />
    },
    {
      id: 2,
      titulo: "Remoção de Calos e Calosidades",
      descricao: "Desbaste seguro e higiênico para devolver o conforto ao caminhar e a maciez da pele dos seus pés.",
      icone: <Feather size={24} className="text-brand-500" />
    },
    {
      id: 3,
      titulo: "Podologia Preventiva",
      descricao: "Corte técnico das unhas, assepsia, hidratação e orientações para manter seus pés sempre saudáveis.",
      icone: <Sparkles size={24} className="text-brand-500" />
    },
    {
      id: 4,
      titulo: "Cuidado com Pé Diabético",
      descricao: "Atenção redobrada e técnicas seguras exclusivas para pacientes diabéticos, prevenindo lesões e infecções.",
      icone: <ShieldCheck size={24} className="text-brand-500" />
    },
    {
      id: 5,
      titulo: "Tratamento de Micoses",
      descricao: "Limpeza profunda e aplicação de produtos específicos para combater fungos nas unhas (onicomicose).",
      icone: <Activity size={24} className="text-brand-500" />
    },
    {
      id: 6,
      titulo: "Órteses de Correção",
      descricao: "Aplicação de dispositivos para corrigir a curvatura da unha, evitando que ela volte a encravar.",
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800 bg-slate-50">
      ...
      <nav className="fixed w-full bg-white/90 backdrop-blur-md z-50 border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo(0,0)}>
              ...
              <div>
                <h1 className="text-2xl font-bold text-brand-900 tracking-tight leading-none">Tecnopé</h1>
                <p className="text-[10px] text-slate-500 font-medium tracking-wide uppercase">Podologia Ana e Nei</p>
              </div>
            </div>

            {/* Menu Desktop */}
            <div className="hidden md:flex items-center gap-8">
              <a href="#servicos" className="text-slate-600 hover:text-brand-600 font-medium transition-colors">Tratamentos</a>
              <a href="#sobre" className="text-slate-600 hover:text-brand-600 font-medium transition-colors">A Clínica</a>
              <a href="#localizacao" className="text-slate-600 hover:text-brand-600 font-medium transition-colors">Localização</a>
              
              <button className="bg-brand-500 hover:bg-brand-600 text-white px-6 py-2.5 rounded-full font-bold transition-all shadow-md hover:shadow-brand-500/40 flex items-center gap-2">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 p-4 flex flex-col gap-4 shadow-xl">
            <a href="#servicos" onClick={() => setIsMenuOpen(false)} className="text-slate-600 font-medium p-2">Tratamentos</a>
            <a href="#sobre" onClick={() => setIsMenuOpen(false)} className="text-slate-600 font-medium p-2">A Clínica</a>
            <a href="#localizacao" onClick={() => setIsMenuOpen(false)} className="text-slate-600 font-medium p-2">Localização</a>
            <button className="bg-brand-500 text-white p-3 rounded-xl font-bold flex items-center justify-center gap-2 w-full mt-2">
      ...
      <main className="pt-32 pb-16 md:pt-40 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12 bg-slate-50">
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-xl mx-auto md:mx-0 leading-relaxed">
            A <strong>Tecnopé (Podologia Ana e Nei)</strong> oferece tratamentos avançados e indolores para unhas encravadas, calosidades e saúde preventiva. Volte a caminhar com conforto e segurança.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <button className="w-full sm:w-auto bg-brand-500 hover:bg-brand-600 text-white px-8 py-4 rounded-full font-bold transition-all shadow-lg shadow-brand-500/30 flex items-center justify-center gap-2 text-lg active:scale-95">
          ...
          <div className="mt-10 flex items-center justify-center md:justify-start gap-6 text-slate-500 text-sm font-medium">
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                ...
                <div className="w-6 h-6 rounded-full bg-slate-400 border-2 border-white flex items-center justify-center text-[8px] text-white font-bold">+</div>
              </div>
        ...
        <div className="flex-1 w-full max-w-lg md:max-w-none relative">
          ...
          <div className="bg-slate-200 w-full aspect-square md:aspect-[4/3] rounded-[3rem] flex items-center justify-center border-8 border-white shadow-2xl relative overflow-hidden">
            <div className="text-center p-6">
              <p className="text-slate-400 font-medium mb-2">Espaço para a Foto Principal</p>
            </div>
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-4 animate-bounce" style={{ animationDuration: '3s' }}>
              ...
              <div>
                <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Ambiente</p>
                <p className="text-sm font-black text-slate-800">100% Esterilizado</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* --- SEÇÃO DE SERVIÇOS --- */}
      <section id="servicos" className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h3 className="text-brand-600 font-bold tracking-wide uppercase text-sm mb-3">Nossos Tratamentos</h3>
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-6">
              Cuidado especializado para cada necessidade dos seus pés
            </h2>
            <p className="text-slate-600 text-lg">
              Utilizamos técnicas modernas e materiais esterilizados para garantir saúde, conforto e bem-estar em todos os nossos procedimentos.
            </p>
          </div>
      ...
      <section id="sobre" className="py-20 bg-brand-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1">
            <h3 className="text-brand-300 font-bold tracking-wide uppercase text-sm mb-3">Conheça a Clínica</h3>
            ...
            <p className="text-brand-100 text-lg mb-8 leading-relaxed text-justify">
              A <strong>Tecnopé</strong> nasceu da união da paixão pelo cuidado humano da Ana e do Nei. Com anos de experiência em podologia clínica, nosso objetivo é proporcionar alívio imediato e qualidade de vida para nossos pacientes na cidade de Bagé.
            </p>
            
            <ul className="space-y-4 mb-10">
              <li className="flex items-start gap-4">
                <div className="bg-brand-800 p-2 rounded-lg"><ShieldPlus size={20} className="text-brand-400" /></div>
                <div>
                  <h4 className="font-bold text-white">Biossegurança Rigorosa</h4>
                  <p className="text-brand-200 text-sm">Materiais 100% esterilizados em autoclave (padrão hospitalar) e descartáveis.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-brand-800 p-2 rounded-lg"><HeartPulse size={20} className="text-brand-400" /></div>
                <div>
                  <h4 className="font-bold text-white">Atendimento Humanizado</h4>
                  <p className="text-brand-200 text-sm">Entendemos a sua dor. O procedimento é feito com calma e máximo conforto.</p>
                </div>
              </li>
            </ul>
      ...
      {/* --- FOOTER & LOCALIZAÇÃO --- */}
      <footer id="localizacao" className="bg-slate-900 text-slate-300 pt-16 pb-8 border-t-4 border-brand-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 border-b border-slate-800 pb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white leading-none">Tecnopé</h1>
                  <p className="text-[10px] text-slate-400 font-medium tracking-wide uppercase">Podologia Ana e Nei</p>
                </div>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed mb-6 text-justify">
                A referência em cuidados com a saúde e estética dos pés em Bagé/RS. Tratamentos avançados, sem dor e com total biossegurança.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="font-medium text-slate-200">Segunda a Sexta</p>
                    <p className="text-slate-400">08:00 às 12:00 - 13:30 às 18:00</p>
                  </div>
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <Phone size={18} className="text-brand-500" />
                  <div>
                    <p className="font-medium text-slate-200">WhatsApp / Telefone</p>
            ...
            <div>
              <h3 className="text-white font-bold mb-6 uppercase tracking-wider text-sm">Onde Estamos</h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
            <p>&copy; 2026 Tecnopé (Podologia Ana e Nei). Todos os direitos reservados.</p>
